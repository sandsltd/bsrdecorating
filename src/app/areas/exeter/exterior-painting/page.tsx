...
export default function ExeterExteriorPaintingPage() {
  ...
  const structuredData = {
    ...
    "hasOfferCatalog": {
      ...
      "itemListElement": [
        { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "House Exterior Painting Exeter" } },
        { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Listed Building Exterior Painting Exeter" } },
        { "@type": "Offer", "itemOffered": { "@type": "Service", "name": "Commercial Exterior Painting Exeter" } }
      ]
    }
  };
