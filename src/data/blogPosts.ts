...
export const blogPosts: BlogPost[] = [
  {
    ...
    excerpt: 'How to read decorator reviews in Exeter properly—spot genuine expertise, avoid red flags and find the right professional for your period or modern home.',
  ...
  {
    id: 34,
    title: 'Exterior Painting Exeter: Your Complete Spring Timing and Preparation Guide',
    excerpt: 'Why March to May is the perfect window for exterior painting in Exeter, and how to plan your project for lasting results in Devon\'s coastal climate.',
  ...
  {
    id: 31,
    title: 'Conservation Area Painting Rules Exeter: What Needs Planning Permission in 2026',
    excerpt: 'Essential guide to painting rules in Exeter\'s 20 conservation areas. What needs permission, what doesn\'t, and how to avoid costly fines.',
    category: 'Heritage Restoration',
    date: '2026-03-17',
    readTime: '9 min read',
  ...
  },
  {
    ...
    excerpt: 'Expert advice on identifying, treating and preventing damp before painting Exeter homes. Stop the cycle of paint failure in period and modern properties.',
    category: 'Expert Advice',
    date: '2026-02-19',
    readTime: '9 min read',
