...
export const blogPosts: BlogPost[] = [
  ...
  {
    id: 31,
    title: 'Conservation Area Painting Rules Devon: What Needs Planning Permission in 2026',
    excerpt: 'Complete guide to conservation area painting rules in Exeter and Topsham. Learn what needs planning permission and avoid costly mistakes.',
    category: 'Heritage Restoration',
    date: '2026-03-17',
    readTime: '8 min read',
