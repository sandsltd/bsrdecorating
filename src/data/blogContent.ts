...
export const blogContent: Record<string, BlogContentData> = {
  ...
  'spring-exterior-painting-exeter-complete-guide': {
    sections: [
      {
        type: 'paragraph',
        content: 'After months of winter rain and coastal winds, exterior paintwork across Exeter shows the strain. Peeling paint on Victorian terrace fronts in St Leonard\'s, faded timber cladding on Topsham riverside properties, and weathered render on new builds in the Liveable Exeter developments—all signal the same need: spring exterior painting. For the 32,600 owner-occupied homes in Exeter, the six-week window between late March and early May represents the best opportunity for exterior decorating work that lasts. Understanding why this timing matters, how to prepare properly, and what to expect from professional painters can save you thousands in premature repainting and ensure your home looks its best through Devon\'s summer months.',
      },
      {
        type: 'heading',
        content: 'Why Spring Offers the Best Conditions for Exterior Painting in Exeter',
        level: 2,
      },
      {
        type: 'paragraph',
        content: 'Exeter\'s maritime climate creates specific challenges for exterior painting. The combination of coastal humidity from the Exe Estuary, prevailing south-westerly winds, and variable rainfall means timing your painting project correctly makes the difference between work that lasts ten years and paint that fails within two.',
      },
      {
        type: 'subheading',
        content: 'The Temperature Window That Matters',
        level: 3,
      },
      {
        type: 'paragraph',
        content: 'Modern exterior paints require substrate temperatures between 10 and 25 degrees Celsius to cure properly. Too cold, and the paint film doesn\'t form correctly, leading to poor adhesion and early failure. Too hot, and the paint dries before it can bond with the surface, creating a weak layer prone to peeling. In Exeter, March through early May typically delivers daytime temperatures in this ideal range, with minimal overnight frost risk that can damage freshly applied coatings.',
      },
      {
        type: 'paragraph',
        content: 'For heritage properties in conservation areas like Topsham, Pennsylvania Park, or St Leonard\'s, where [breathable paints and traditional specifications](/blog/painting-listed-buildings-exeter-breathable-paint-consent-mistakes) matter, these temperature conditions become even more critical. Lime-based paints and mineral paints require slow, steady curing that spring\'s mild temperatures facilitate perfectly.',
      },
      {
        type: 'subheading',
        content: 'Managing Devon\'s Spring Rainfall',
        level: 3,
      },
      {
        type: 'paragraph',
        content: 'Spring in Exeter brings lighter, more predictable rainfall than autumn\'s extended wet periods. Between March and May, rain typically arrives in shorter bursts, allowing experienced exterior painters to work productively around showers. Surfaces need 24-48 hours of dry conditions after preparation and between coats—achievable in spring, difficult in November through February when continuous damp weather can delay projects by weeks.',
      },
      {
        type: 'paragraph',
        content: 'For coastal properties in areas like Exmouth Road, Topsham waterfront, or the Quay, salt-laden rain can deposit corrosive residue on fresh paint. Spring\'s lighter rainfall reduces this risk compared to winter storms, giving new paint films time to cure and harden before facing harsher autumn and winter conditions.',
      },
      {
        type: 'subheading',
        content: 'Avoiding Summer\'s Peak Demand and Heat Challenges',
        level: 3,
      },
      {
        type: 'paragraph',
        content: 'By June, professional decorators across Exeter typically carry 4 to 6 week waiting lists. Planning exterior painting for April or early May means you avoid these delays and secure your preferred dates. You also sidestep July and August\'s occasional heat spells, when direct sunlight on south-facing walls can push surface temperatures above 30 degrees—too hot for proper paint application and curing.',
      },
      {
        type: 'paragraph',
        content: 'Early booking allows you to enjoy your freshly painted property throughout summer when gardens and outdoor spaces see most use. For properties with external entertaining areas or summer rental potential, this timing maximises your investment.',
      },
      {
        type: 'heading',
        content: 'Preparing Exeter Properties for Spring Exterior Painting',
        level: 2,
      },
      {
        type: 'paragraph',
        content: 'Proper preparation determines how long exterior painting lasts. In Devon\'s climate, cutting preparation corners leads to premature failure—often within 12 to 18 months rather than the 8 to 12 years properly prepared work delivers.',
      },
      {
        type: 'subheading',
        content: 'Winter Damage Assessment and Repairs',
        level: 3,
      },
      {
        type: 'paragraph',
        content: 'Before any painting begins, inspect for damage from winter weather. Common issues on Exeter properties include:',
      },
      {
        type: 'list',
        content: [
          'Render cracks from freeze-thaw cycles, particularly on north and east-facing elevations exposed to cold winds from Dartmoor',
          'Rotten timber fascias and window frames where gutters have overflowed during heavy rain periods',
          'Blown and flaking existing paint from moisture ingress through failed caulking or pointing',
          'Iron oxide staining around metalwork, common on Victorian properties in St Leonard\'s and Heavitree',
          'Salt damage on coastal properties, especially in Topsham and along the Exmouth Road corridor where sea spray reaches during storms',
        ],
      },
      {
        type: 'paragraph',
        content: 'Addressing these repairs before painting prevents new paint from hiding problems that will only worsen. On the 994 listed buildings in Exeter, repairs must follow conservation guidelines—another reason to work with experienced heritage decorators who understand specifications for properties in Topsham\'s conservation area or St David\'s ward, which contains 380 of the city\'s listed structures.',
      },
      {
        type: 'subheading',
        content: 'Surface Preparation That Lasts',
        level: 3,
      },
      {
        type: 'paragraph',
        content: 'Professional exterior painting preparation includes comprehensive cleaning, scraping, sanding, and priming—work that typically represents 60 to 70 percent of project time but determines whether your paint lasts two years or twenty.',
      },
      {
        type: 'paragraph',
        content: 'For rendered properties common throughout Exeter\'s Victorian terraces, preparation means removing all loose and flaking material, treating biological growth from Devon\'s humid climate, and stabilising porous surfaces with appropriate stabilising primers. For timber elements—sash windows, fascias, cladding—preparation involves removing all failed coatings back to sound material, treating bare wood with preservative, filling with flexible exterior fillers, and applying oil-based primers that seal against moisture ingress.',
      },
      {
        type: 'paragraph',
        content: 'Properties in exposed locations such as Topsham waterfront or elevated areas around Pennsylvania require particular attention to weather-damaged areas where wind-driven rain has penetrated existing coatings.',
      },
      {
        type: 'heading',
        content: 'Choosing the Right Paint Systems for Devon\'s Climate',
        level: 2,
      },
      {
        type: 'paragraph',
        content: 'Not all exterior paints suit Exeter\'s coastal climate and diverse property types. Selecting appropriate materials for your specific property age, construction, and exposure determines longevity and appearance.',
      },
      {
        type: 'subheading',
        content: 'Modern Masonry Paints for Post-1919 Properties',
        level: 3,
      },
      {
        type: 'paragraph',
        content: 'For standard rendered properties built after 1919, modern acrylic masonry paints offer excellent durability and weather resistance. These paints flex with substrate movement, resist algae and mould growth, and cope well with Devon\'s wet conditions. Premium brands provide 12 to 15 year performance on properly prepared surfaces—crucial for properties in areas like the Liveable Exeter developments or post-war housing in Pinhoe and Whipton.',
      },
      {
        type: 'paragraph',
        content: 'For new builds in developments like Cranbrook, where early paint failure remains common due to construction moisture and insufficient substrate curing, breathable masonry paints that allow trapped moisture to escape prevent the blistering and peeling that affects many properties within their first five years.',
      },
      {
        type: 'subheading',
        content: 'Heritage Paint Specifications',
        level: 3,
      },
      {
        type: 'paragraph',
        content: 'Pre-1919 properties—including the 228 listed buildings in Topsham and extensive Victorian stock in St Leonard\'s, Newtown, and Heavitree—require breathable paint systems that allow moisture movement through walls. Traditional solid-wall construction without damp-proof courses means these properties manage moisture through evaporation, not barriers.',
      },
      {
        type: 'paragraph',
        content: 'Lime-based paints, mineral paints, and breathable masonry coatings suit these properties, allowing walls to \'breathe\' while providing weather protection. Modern plastic masonry paints on period properties trap moisture, causing damp problems, timber decay, and plaster degradation—issues that cost thousands to remedy and damage the very fabric these paints claim to protect.',
      },
      {
        type: 'paragraph',
        content: 'Properties in Exeter\'s 20 conservation areas face additional considerations. [Planning restrictions may specify paint colours and finishes](/blog/conservation-area-painting-rules-devon-planning-permission), and unauthorised changes can result in enforcement action—as demonstrated by the £38,000 fine issued to a Topsham property owner in December 2025 for unauthorised alterations.',
      },
      {
        type: 'subheading',
        content: 'Exterior Timber and Metalwork Specifications',
        level: 3,
      },
      {
        type: 'paragraph',
        content: 'For windows, doors, fascias, and other timber elements, oil-based undercoats and gloss finishes still offer superior durability and protection compared to water-based alternatives, particularly on exposed elevations facing prevailing winds. Modern low-VOC oil paints provide traditional performance with reduced environmental impact.',
      },
      {
        type: 'paragraph',
        content: 'For metalwork—railings, gates, balconies common on Victorian properties—proper rust removal, rust-inhibiting primers, and compatible topcoats prevent the rapid corrosion Devon\'s salty, humid air accelerates. Coastal properties require particular attention to specification, as inadequate protection leads to failure within 12 to 24 months.',
      },
      {
        type: 'heading',
        content: 'What to Expect from Professional Exterior Painters in Spring',
        level: 2,
      },
      {
        type: 'paragraph',
        content: 'Understanding typical project timelines, working methods, and cost factors helps you plan effectively and choose the right contractor for your Exeter property.',
      },
      {
        type: 'subheading',
        content: 'Realistic Project Timescales',
        level: 3,
      },
      {
        type: 'paragraph',
        content: 'A typical three-bedroom semi-detached house in Exeter requires approximately 7 to 12 working days for complete exterior painting, depending on condition and specification. This breaks down as 4 to 7 days preparation and 3 to 5 days painting. Larger properties, poor existing condition, or heritage specifications extend timescales accordingly.',
      },
      {
        type: 'paragraph',
        content: 'Spring\'s variable weather means professional decorators build flexibility into schedules. Wet days prevent painting but allow preparation work. Experienced contractors plan for weather interruptions rather than promising fixed completion dates that become impossible when April showers arrive.',
      },
      {
        type: 'subheading',
        content: 'Exeter Exterior Painting Costs',
        level: 3,
      },
      {
        type: 'paragraph',
        content: 'Based on current Exeter pricing, [whole house exterior painting typically costs between £1,500 and £3,500](/blog/exterior-painting-costs-exeter-what-affects-quote-2026) for standard properties, with the average around £1,728. This includes all preparation, materials, and labour. Heritage properties with specialist paint specifications and extensive preparation requirements may cost £3,000 to £6,000, reflecting the additional time and materials involved.',
      },
      {
        type: 'paragraph',
        content: 'Front door repainting averages £123, while single elevations on terraced properties typically cost £400 to £800 depending on height and access requirements. Properties requiring scaffolding—three-storey Victorians in St Leonard\'s, for example—incur additional costs of £500 to £1,200 for scaffold hire.',
      },
      {
        type: 'paragraph',
        content: 'Spring booking often provides better value than peak summer rates, and many decorators offer slight discounts for advance booking that fills their April and May schedules.',
      },
      {
        type: 'heading',
        content: 'Common Exterior Painting Mistakes to Avoid',
        level: 2,
      },
      {
        type: 'paragraph',
        content: 'Several errors commonly shorten the life of exterior painting projects on Exeter properties. Avoiding these protects your investment and ensures lasting results.',
      },
      {
        type: 'list',
        content: [
          'Painting too early in the season when overnight temperatures still drop below 8 degrees, preventing proper paint curing',
          'Choosing the cheapest quote without comparing preparation specifications—inadequate preparation guarantees early failure regardless of paint quality',
          'Using modern plastic masonry paints on pre-1919 solid-wall properties, trapping moisture and causing damp problems',
          'Painting over biological growth, dirt, or chalking surfaces without proper cleaning—new paint simply won\'t adhere',
          'Skipping primer coats on bare timber or previously painted surfaces showing age—primers bond subsequent coats and seal porous substrates',
          'Applying only one topcoat to save money—two coats provide necessary film thickness for weather protection and longevity',
          'Failing to check conservation area or listed building requirements before changing exterior colours or finishes',
        ],
      },
      {
        type: 'heading',
        content: 'Booking Your Spring Exterior Painting Project',
        level: 2,
      },
      {
        type: 'paragraph',
        content: 'For exterior painting work between late March and May, booking in January or early February secures your preferred dates. Professional decorators fill spring schedules quickly as homeowners recognise the seasonal advantages.',
      },
      {
        type: 'paragraph',
        content: 'When requesting quotes, provide clear information about your property type, age, location, and current condition. For heritage properties in areas like Topsham, St Leonard\'s conservation area, or among Exeter\'s 994 listed buildings, mention conservation status and any previous paint failures. This allows contractors to specify appropriate materials and preparation methods from the outset.',
      },
      {
        type: 'paragraph',
        content: 'For comprehensive exterior painting in Exeter that delivers lasting results in Devon\'s coastal climate, professional preparation, heritage-appropriate specifications, and spring\'s ideal working conditions combine to protect your property investment for the decade ahead.',
      },
      {
        type: 'quoteCTA',
        content: 'Planning exterior painting this spring? BSR Decorating provides comprehensive exterior painting services across Exeter, Topsham, and Devon, with specialist expertise in heritage properties and breathable paint systems. Contact us for a detailed assessment and quote for your spring exterior painting project.',
      },
    ],
  },
  'conservation-area-painting-rules-devon-planning-permission': {
    sections: [
      {
        type: 'paragraph',
        content: 'If you own property in one of Exeter\'s 20 conservation areas—from Topsham\'s Georgian waterfront to St Leonard\'s Victorian terraces—you\'ll know the privilege of living amongst Devon\'s finest period architecture. But when it\'s time to refresh your home\'s exterior paintwork, the planning rules can feel like navigating a maze.',
      },
      {
        type: 'paragraph',
        content: 'The stakes are high. In December 2025, a Topsham property owner was fined £38,000 for unauthorised work on a listed building. Whilst most conservation area painting doesn\'t require planning permission, knowing exactly where the line falls could save you months of delays, thousands in fines, and the headache of retrospective applications.',
      },
      {
        type: 'paragraph',
        content: 'As an [Exeter-based decorator](/areas/exeter) with over 20 years\' experience working on [heritage properties across Devon](/areas/exeter/heritage-property-painting), I\'ve guided countless homeowners through these regulations. This article explains precisely what conservation area painting rules apply in 2026, what you can do without permission, and when you\'ll need to submit an application to Exeter City Council.',
      },
      {
        type: 'heading',
        content: 'Understanding Exeter\'s Conservation Areas',
        level: 2,
      },
      {
        type: 'paragraph',
        content: 'Conservation areas are designated by Exeter City Council and East Devon District Council to protect neighbourhoods of special architectural or historic character. The objective isn\'t to prevent all change—it\'s to ensure that alterations respect and enhance the area\'s distinctive qualities.',
      },
      {
        type: 'paragraph',
        content: 'Exeter has 20 conservation areas protecting everything from medieval streets to Victorian suburbs. The most significant include Topsham (228 listed buildings), St Leonard\'s (120 listed buildings), Pennsylvania Park, Baring Crescent/Mont le Grand, Southernhay, St David\'s/Longbrook, Heavitree, Alphington, and the Cathedral Quarter. Topsham alone spans the historic waterfront, Fore Street, and surrounding Georgian and Victorian streets.',
      },
      {
        type: 'paragraph',
        content: 'Living in a conservation area means certain \'permitted development\' rights—automatic permissions that apply to most homes—are withdrawn. External alterations that wouldn\'t need approval in a modern estate often require planning consent in conservation areas. This affects everything from satellite dishes to windows, but painting rules are more nuanced.',
      },
      {
        type: 'heading',
        content: 'What Exterior Painting Doesn\'t Need Planning Permission',
        level: 2,
      },
      {
        type: 'paragraph',
        content: 'The reassuring news: the majority of routine external painting and maintenance doesn\'t require planning permission, even in conservation areas. Like-for-like painting that maintains the building\'s character is generally permitted development.',
      },
      {
        type: 'paragraph',
        content: 'You can proceed without planning permission for:',
      },
      {
        type: 'list',
        content: [
          'Repainting rendered or plastered walls in historically appropriate colours that suit the building\'s age and the area\'s character',
          'Painting or repainting wooden windows, doors, fascias, bargeboards, and other timber elements in traditional colours',
          'Repainting existing decorative ironwork, railings, gates, and balconies',
          'Maintaining and repainting existing stucco, render, or decorative plasterwork',
          'Touching up or repainting previously painted brickwork or stonework (though painting unpainted masonry is different—see below)',
          'Repainting gutters, downpipes, and rainwater goods in traditional colours like black, dark grey, or to match existing schemes',
        ],
      },
      {
        type: 'paragraph',
        content: 'The critical principle: if your property has been painted a certain way historically and you\'re maintaining that finish, you typically won\'t need permission. Repainting a cream-rendered Georgian house in Topsham in a similar cream shade? Generally fine. Repainting Victorian sash windows in Heavitree in traditional white or off-white? Usually permitted.',
      },
      {
        type: 'heading',
        content: 'When You DO Need Planning Permission',
        level: 2,
      },
      {
        type: 'paragraph',
        content: 'Planning permission is required when your painting work materially alters the building\'s appearance or introduces changes that affect the conservation area\'s character. This includes:',
      },
      {
        type: 'list',
        content: [
          'Painting previously unpainted brickwork or stonework—this is considered a material alteration and almost always requires permission in conservation areas',
          'Painting render, walls, or woodwork in colours that are historically inappropriate or out of character with the building and surrounding area (bright modern colours, for example)',
          'Removing existing paint from historic brickwork or stonework through aggressive methods like sandblasting, which can cause irreversible damage',
          'Changing the colour scheme dramatically—for example, painting a traditional cream Georgian house in Topsham in bright blue or pink',
          'Painting or treating exterior walls with non-breathable modern paints on historic buildings where breathable finishes are required',
          'Altering decorative features, mouldings, or architectural details that contribute to the building\'s character',
        ],
      },
      {
        type: 'paragraph',
        content: 'The December 2025 Topsham case demonstrates the importance of compliance. The £38,000 fine was issued for unauthorised alterations to a listed building—a stark reminder that councils enforce these regulations seriously, particularly when work damages historic fabric.',
      },
      {
        type: 'heading',
      ...
      {
        type: 'paragraph',
        content: 'If your property is a listed building (Grade I, II*, or II), even stricter controls apply. Exeter has 994 listed buildings across its conservation areas, with the highest concentrations in St David\'s (380), Topsham (228), and St Leonard\'s/Newtown (120).',
      },
      {
        type: 'paragraph',
        content: 'For listed buildings, you need Listed Building Consent for any work that affects the character of the building—even internal alterations. External painting that changes the appearance, uses inappropriate materials, or damages historic fabric requires consent. This includes:',
      },
      {
        type: 'list',
        content: [
          'Changing exterior colour schemes',
          'Using modern non-breathable paints on historic masonry or render',
          'Painting previously unpainted surfaces',
          'Removing existing paint finishes',
          'Using inappropriate preparation methods',
        ],
      },
      {
        type: 'paragraph',
        content: 'Many [Topsham homeowners](/areas/topsham) discover their property is listed when they first consider exterior work. Always check your property\'s listing status on the Historic England website or Exeter City Council\'s planning portal before starting any project.',
      },
      {
        type: 'heading',
        content: 'Choosing Appropriate Paint Colours',
        level: 2,
      },
      {
        type: 'paragraph',
        content: 'Even when planning permission isn\'t required, choosing historically appropriate colours is essential both for respecting your property\'s character and avoiding potential planning issues. In Exeter\'s conservation areas, traditional palettes dominate.',
      },
      {
        type: 'paragraph',
        content: 'For Georgian and early Victorian properties (common in Topsham, Southernhay, and Pennsylvania), appropriate render colours include off-whites, creams, warm stone colours, and soft greys. Woodwork traditionally used white, off-white, dark green, black, or dark grey. Brightly coloured front doors were rare—stick to traditional greens, black, dark blue, or burgundy.',
      },
      {
        type: 'paragraph',
        content: 'Later Victorian and Edwardian properties (prevalent in St Leonard\'s, Heavitree, and Newtown) often featured warmer palettes—terracotta, buff, ochre, and sage green for render, with contrasting trim in cream, white, dark green, or brown.',
      },
      {
        type: 'paragraph',
        content: 'If you\'re uncertain, look at neighbouring period properties that haven\'t been altered, consult Exeter City Council\'s conservation area appraisals (available online), or speak with a [specialist heritage decorator](/areas/exeter/heritage-property-painting) who understands local architectural history. I\'ve worked on dozens of conservation area properties and can advise on appropriate schemes for your specific building and location.',
      },
      {
        type: 'heading',
        content: 'The Right Paint Type Matters',
        level: 2,
      },
      {
        type: 'paragraph',
        content: 'In conservation areas—especially on older properties—choosing the correct paint type is as important as colour. Many pre-1919 buildings were constructed with lime mortar, lime render, or soft bricks that need to breathe. Trapping moisture with modern plastic-based paints causes damp, decay, and structural damage.',
      },
      {
        type: 'paragraph',
        content: 'For historic buildings, breathable paints are essential. These include traditional lime wash, mineral silicate paints, and modern breathable masonry paints specifically designed for heritage properties. These allow water vapour to escape whilst protecting against rain penetration.',
      },
      {
        type: 'paragraph',
        content: 'On timber elements—windows, doors, fascias—use microporous paints that allow moisture movement whilst providing weather protection. Avoid cheap gloss paints that crack and peel rapidly in Devon\'s damp climate.',
      },
      {
        type: 'paragraph',
        content: 'I\'ve written a detailed guide on [choosing the best paint for Devon\'s coastal weather](/blog/best-exterior-paint-devon-coastal-weather), which covers breathable options suitable for conservation area properties.',
      },
      {
        type: 'heading',
        content: 'How to Apply for Planning Permission',
        level: 2,
      },
      {
        type: 'paragraph',
        content: 'If your proposed painting work requires planning permission or Listed Building Consent, the application process through Exeter City Council is straightforward but requires careful preparation.',
      },
      {
        type: 'paragraph',
        content: 'You\'ll need to submit:',
      },
      {
        type: 'list',
        content: [
          'A completed application form (available on Exeter City Council\'s planning portal)',
          'Detailed drawings or photographs showing existing and proposed colours',
          'Paint manufacturer details and colour references',
          'A heritage statement explaining why your proposals are appropriate (for listed buildings)',
          'The application fee (varies depending on application type)',
        ],
      },
      {
        type: 'paragraph',
        content: 'The council typically decides within eight weeks for planning permission and eight weeks for Listed Building Consent. If your application is refused, you can revise and resubmit with modifications addressing the council\'s concerns.',
      },
      {
        type: 'paragraph',
        content: 'Exeter City Council\'s conservation officers are helpful and can provide pre-application advice. For complex projects, this informal guidance (sometimes chargeable) can save time and increase approval chances.',
      },
      {
        type: 'heading',
        content: 'What Happens If You Don\'t Get Permission?',
        level: 2,
      },
      {
        type: 'paragraph',
        content: 'Carrying out unauthorised work in a conservation area or on a listed building can result in enforcement action. The council can issue an enforcement notice requiring you to reverse the work—meaning repainting at your expense—or apply for retrospective permission.',
      },
      {
        type: 'paragraph',
        content: 'For listed buildings, unauthorised alterations are a criminal offence under the Planning (Listed Buildings and Conservation Areas) Act 1990. Maximum penalties include unlimited fines and up to two years\' imprisonment for deliberate damage. The £38,000 Topsham fine demonstrates councils\' willingness to prosecute serious breaches.',
      },
      {
        type: 'paragraph',
        content: 'Even if prosecution doesn\'t follow, unauthorised work creates problems when selling. Solicitors\' searches reveal planning breaches, potentially scuppering sales or requiring expensive remediation before completion.',
      },
      {
        type: 'heading',
        content: 'Working with a Heritage Painting Specialist',
        level: 2,
      },
      {
        type: 'paragraph',
        content: 'Conservation area and listed building painting requires specialist knowledge—understanding breathable materials, appropriate colour palettes, traditional techniques, and planning requirements. Choosing an experienced heritage decorator saves time, avoids costly mistakes, and ensures your property receives appropriate treatment.',
      },
      {
        type: 'paragraph',
        content: 'At BSR Decorating, I\'ve worked on [heritage properties throughout Exeter and Topsham](/areas/exeter/heritage-property-painting) for over two decades. I can advise on colour selection, specify appropriate breathable paints, prepare applications if needed, and deliver finishes that respect your property\'s character whilst providing lasting protection against Devon\'s coastal weather.',
      },
      {
        type: 'paragraph',
        content: 'I\'ve helped homeowners navigate everything from straightforward repaints in Heavitree conservation area to complex Listed Building Consent applications for Grade II properties in Topsham. My knowledge of Exeter\'s architectural history and council requirements means your project proceeds smoothly, compliantly, and beautifully.',
      },
      {
        type: 'quoteCTA',
        content: 'Planning exterior painting work on your conservation area or listed property in Exeter or Topsham? Get expert advice on planning requirements, appropriate colours, and breathable paint specifications. Call BSR Decorating for a free consultation and quote.',
      },
      {
        type: 'heading',
        content: 'Key Takeaways: Conservation Area Painting Rules',
        level: 2,
      },
      {
        type: 'list',
        content: [
          'Most routine repainting in similar, historically appropriate colours doesn\'t need planning permission in conservation areas',
          'Painting previously unpainted brickwork or stonework, or using inappropriate colours, typically requires permission',
          'Listed buildings have stricter rules—Listed Building Consent may be needed even for repainting',
          'Choose breathable paints for pre-1919 buildings to avoid damp and structural problems',
          'Select colours appropriate to your property\'s age and the area\'s character—consult conservation area appraisals if unsure',
          'Unauthorised work can result in enforcement action, fines up to £38,000+, and complications when selling',
          'Pre-application advice from Exeter City Council\'s conservation officers can clarify requirements before you start',
          'Working with an experienced heritage decorator ensures compliance, appropriate materials, and high-quality results',
        ],
      },
      {
        type: 'paragraph',
        content: 'Conservation area regulations exist to protect the architectural heritage that makes Exeter and Topsham such special places to live. By understanding the rules, choosing appropriate colours and materials, and seeking permission when required, you can maintain your property beautifully whilst preserving its character for future generations.',
      },
      {
        type: 'paragraph',
        content: 'Whether you\'re refreshing a cream-rendered Georgian townhouse in Topsham, repainting Victorian sash windows in St Leonard\'s, or tackling render repairs in Pennsylvania, [professional guidance from an experienced Exeter decorator](/areas/exeter) ensures your project enhances rather than compromises your home\'s historic value.',
      },
    ],
  },
