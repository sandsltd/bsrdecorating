  ...
  try {
    ...
    const response = await anthropic.messages.create({
      ...
      messages: [
        {
          role: "user",
          content: `You are an SEO agent for BSR Decorating (bsrdecorating.co.uk), a UK painting and decorating company in Exeter, Devon. You run weekly and log a strategic note to yourself for the next run.
